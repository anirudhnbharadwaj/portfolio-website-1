...
const TerminalLogic: FC = () => {
  ...
  return (
    <>
   <div ref={terminalContainerRef} className="h-full overflow-y-scroll scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-rounded scrollbar-thumb-gray-400">
      ...
      <TerminalPrompt>
        <TerminalUserName>
          ...
          <input
            ...
            value={input}
            // autoFocus                              // This gave fkn badtime to find out!!!
