...
const FeaturedProject = ({
  ...
  return (
    ...
    >
      ...
      {/* Featured Proj Image Container*/ }

      {/* <div
        className={cn(
          'w-full lg:max-w-[30%] absolute inset-0 h-full -z-20 lg:z-0 lg:object-contain rounded overflow-hidden shadow-2xl group',
      ...
      {/* Featured Proj Text Container*/ }
      <div
        className={cn(
          'lg:max-w-[50%] space-y-2 lg:space-y-5 w-full h-full p-5 lg:p-0',
